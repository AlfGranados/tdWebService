"""
Django's settings for TrackDrive1 project.
...
SECRET_KEY = '9ooy_6b1gx8(qzgfz=rx#3y&@u=9=i@*t(vjuv+-z))776d-8+=ul+o&+z555b#_a-+ghpdgbcnatp9z=_8-cc(_z^lc'
...
WSGI_APPLICATION = 'TrackDrive1.wsgi.application'
